...
* Update hardcoded [seeds](/contrib/seeds/README.md). TODO: Give example PR for DMS
...
NOTE: Offline builds must use the --url flag to ensure Gitian fetches only from local URLs. For example:
    ...
    pushd ./gitian-builder
    ./bin/gbuild --url dms=/path/to/dms,signature=/path/to/sigs {rest of arguments}
    popd
...
### Build and sign DMS Core for Linux, Windows, and OS X:
    ...
    pushd ./gitian-builder
    ./bin/gbuild --memory 3000 --commit dms=v${VERSION} ../documentchain/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --memory 3000 --commit dms=v${VERSION} ../documentchain/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --memory 3000 --commit dms=v${VERSION} ../documentchain/contrib/gitian-descriptors/gitian-osx.yml
...
- Detached signatures will then be committed to the [dms-detached-sigs](https://github.com/Krekeler/documentchain-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the dms.org server*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the dms.cash server
