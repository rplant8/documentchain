...
UniValue debug(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "                       mempoolrej, net, proxy, prune, qt, rand, reindex, rpc, selectcoins, tor, zmq, dms\n"
...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\"")
            + HelpExampleRpc("validateaddress", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\"")
        );
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\", \"signature\", \"my message\"")
        );
...
UniValue getaddressmempool(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\"]}")
        );
...
UniValue getaddressutxos(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\"]}")
        );
...
UniValue getaddressdeltas(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1 || !request.params[0].isObject())
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\"]}")
        );
...
UniValue getaddressbalance(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\"]}")
        );
...
UniValue getaddresstxids(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\"]}")
        );
