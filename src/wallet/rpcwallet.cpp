...
UniValue setaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\", \"tabby\"")
        );
...
UniValue getaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\"")
            + HelpExampleRpc("getaccount", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\"")
        );
...
UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 7)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue instantsendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 5)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("instantsendtoaddress", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\" 0.1")
            + HelpExampleCli("instantsendtoaddress", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("instantsendtoaddress", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("instantsendtoaddress", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue signmessage(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 2)
        throw std::runtime_error(
            ...
            + HelpExampleCli("signmessage", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\", \"my message\"")
        );
...
UniValue getreceivedbyaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n"
            + HelpExampleCli("getreceivedbyaddress", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\", 6")
       );
...
UniValue sendfrom(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 3 || request.params.size() > 7)
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendfrom", "\"\" \"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\" 0.01 6 false \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\", 0.01, 6, false, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\\\":0.01,\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcG\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\\\":0.01,\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcG\\\":0.02}\" 6 false \"testing\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\\\":0.01,\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcG\\\":0.02}\", 6, false, \"testing\"")
        );
...
UniValue walletlock(const JSONRPCRequest& request)
{
    ...
    if (pwallet->IsCrypted() && (request.fHelp || request.params.size() != 0)) {
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\" 1.0") +
...
UniValue listunspent(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("listunspent", "")
            + HelpExampleCli("listunspent", "6 9999999 \"[\\\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\\\",\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcg\\\"]\"")
            + HelpExampleRpc("listunspent", "6, 9999999 \"[\\\"D5ugcfpWFBRF8jryUMoSyvU2vYeXsyYWkc\\\",\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcg\\\"]\"")
        );
